class Spiral(n: Int) {
  ...
  var spiral: Array[Array[Int]] = Array.ofDim[Int](n, n)
  ...
  def changePosition(pos: (Int, Int), dir: Char): ((Int, Int), Char) = {
    var newDir = dir
    val (y, x) = pos
    var newPos = pos
  ...
  def move(pos: (Int, Int), counter: Int): Unit = {
    spiral(pos._1)(pos._2) = counter
  }


  def makeSpiral: Array[Array[Int]] = {
    var position = (0, 0)
    var direction = 'R'
    var counter = 1
